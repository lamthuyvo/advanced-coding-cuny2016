$(document).ready(function(){
	...
	if(electionDate== todaysDate){
		...
		$("#result").append('<p>HUZZAH! It\'s election day. You will finally be anxiety-free tonight!</p>');
		...
		$("#result").append('<p>You made it through this terrible election. #icant2016</p>');
	}
	...
	$('#appbutton').on("click", function(){
		...
		if(electionDate== todaysDate){
			...
			// if it's not election day yet
			$("#result").append('<p>Not yet! Hang in there!</p>');
